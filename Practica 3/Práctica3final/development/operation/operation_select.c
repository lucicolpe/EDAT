...
/*igual en el resto de operaciones*/
void operation_select_reset(void* vargs) {
...
/*igual en el resto de operaciones menos por algún free*/
...
operation_t* operation_select_create(operation_t* suboperation, condition_t* condition) {
